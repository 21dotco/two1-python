...
The package is organized around an abstract base class. Users of the
21 Bitcoin Computer will want to use the ``TwentyOneProvider`` class
to instantiate a connection to the default provider.
