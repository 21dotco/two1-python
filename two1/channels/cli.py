...
@click.option('--zeroconf', default=False, is_flag=True, help="Use payment channel without deposit confirmation. This preference will be overriden by server configuration if applicable.")
