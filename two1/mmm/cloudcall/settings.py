"""
Django settings for cloudcall project.
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'cloudcall/static'),
)
...
WSGI_APPLICATION = 'cloudcall.wsgi.application'
...
STATIC_SERVE_CONFIG = os.path.dirname(os.path.abspath(__file__)) + '/ss_config.yaml';
