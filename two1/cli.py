...
@click.option('--no-transactions',  # in click 7.0 we can hide this from the help text
              is_flag=True,
              envvar='TWO1_BLOCK_TRANSACTIONS',
              help='Prevent transactions (for developer testing).')
@click.version_option(two1.TWO1_VERSION, message=two1.TWO1_VERSION_MESSAGE)
@click.pass_context
@decorators.catch_all
def main(ctx, config_file, config_pairs, debug, no_transactions):
