...
@pytest.fixture(params=[
    ...
    blockchain.TwentyOneBlockchain("https://dotco-devel-pool2.herokuapp.com/blockchain/bitcoin"),
])
def bc(request):
...
def test_blockchain(bc):
    ...
    assert bc.lookup_tx("101a4d5d9dcd7c73848f499c4c4dd5d114d9a0cb0622c34f29e5e0fa406f3f83") == None
