...
from two1.lib.update import checked_for_an_update_today
from two1.lib.update import update_two1_package
from two1.lib import update
...
def test_check_for_an_update_today():
    ...
    assert not checked_for_an_update_today(config)
